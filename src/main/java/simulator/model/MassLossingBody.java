...
import simulator.model.FluentBluilder.Body;

public class MassLossingBody extends simulator.model.FluentBluilder.Body {
    ...
    public static void main(String[] args) {
        MassLossingBody mlb = new MassLossingBody.Builder().id("b2").velocity(new Vector2D())
                .position(new Vector2D(0,50)).mass(50).lossFactor(1).lossFrequency(1).build();
